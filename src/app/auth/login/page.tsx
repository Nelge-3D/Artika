    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 via-white to-purple-50 p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          >
            Accédez à votre espace artistique
          </motion.p>
        </div>
            ...
            <div className="mt-8">
              ...
              <div className="mt-6">
                <motion.button
                  ...
                  disabled={isLoading}
                  className="w-full flex items-center justify-center py-2.5 px-4 bg-white border border-gray-300 rounded-xl hover:bg-gray-50 transition-colors disabled:opacity-70 disabled:cursor-not-allowed"
                >
