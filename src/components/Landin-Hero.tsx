...
export default function Hero() {
  ...
  return (
    <section className="relative h-screen bg-white overflow-hidden flex items-center justify-center px-4">
      ...
      >
        <motion.h1
          ...
          className="text-4xl md:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 mb-6 drop-shadow"
        >
          {"Plongez dans un univers visuel africain".split('').map((char, i) => (
            <motion.span
              key={i}
              variants={{
